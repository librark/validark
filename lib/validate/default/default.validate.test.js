...
describe('validateDefault', () => {
  ...
  it('throws on null and undefined records', () => {
    ...
    const message = 'The "records" parameter must be an array or an object.'

    expect(() => validateDefault(schema, null)).toThrow(message)
    expect(() => validateDefault(schema, undefined)).toThrow(message)
    expect(() => validateDefault(schema, 'LaLaLa')).toThrow(message)
    expect(() => validateDefault(schema, 123)).toThrow(message)
  })

 ...
 * @param {{strict?: boolean, eager?: boolean}} options
 * @return {Array[Object] | Object}
 * */
export function validateDefault (
  schema,
  records,
  { strict = false, eager = false } = {}
) {
  ...
  const context = { strict, eager, issues: [] }
  const result = validateRecords(schema, values, context, [])
  if (!eager && context.issues.length) {
 ...
 * @param {{strict: boolean, eager: boolean, issues: object[]}} context

...
describe('validate', () => {
  ...
  it('throws on null and undefined records', () => {
    ...
    expect(() => validate(schema, null)).toThrow(message)
    expect(() => validate(schema, undefined)).toThrow(message)
    expect(() => validate(schema, 'LaLaLa')).toThrow(message)
    expect(() => validate(schema, 123)).toThrow(message)
  })
